<x-layout>
    <div class="d-flex align-items-center justify-content-center mt-3">
        <div class="bg-white border rounded-3 shadow col-sm-4 col-md-6 col-lg-6 mx-3 p-4 animate__animated animate__fadeIn">
            ...
            <form method="POST" action="{{ route('profile.update', auth()->id()) }}" enctype="multipart/form-data"
                ...
                {{-- first language --}}
                <div class="col-md-6">
                    <label for="first_language" class="form-label fw-bold">What's your first language <b class="text-danger">*</b></label>
                    <input type="text" class="form-control" id="first_language" name="first_language" value="{{ old('first_language', auth()->user()->first_language) }}" placeholder="English" required>
                </div>
