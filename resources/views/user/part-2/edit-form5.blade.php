<x-layout>
    <div class="d-flex align-items-center justify-content-center mt-3">
        <div
            ...
            <form method="POST" action="{{ route('seek.store', auth()->id()) }}" enctype="multipart/form-data"
                class="row g-3">
                @csrf
                @method('PATCH')
                ...
                {{-- sexual orientation --}}
                <div class="col-md-6">
                    <label for="sexual_orientation" class="form-label fw-bold">Their sexual orientation <b
